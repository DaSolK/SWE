...
class StudentClass {
	...
	public static void add(Student[] st, Scanner scan, int i) {
		if (i == 100)
	...
	public static void view(Student[] st, Scanner scan, int i) throws Exception {
		for (int j = 0; j < i; j++) {
			int k = j + 1;
	...
	public static void update(Student[] st, Scanner scan, int i) {
		Scanner scan1 = new Scanner(System.in);
		System.out
				.print("Enter the student's ID who you want to update phone number:");
	...
	public static void delete(Student[] st, Scanner scan, int i) {
	...
	public static void fileSave(Student [] st, int i) throws Exception{
	...
	public static void fileOpen(Student [] st, int i) throws Exception{
